...
public class NaverLoginBO {
    ...
    private final static String CLIENT_ID = "nQkBa86tJJIeT2DNuV3c";
    private final static String CLIENT_SECRET = "5oKzx82GGP";
    private final static String REDIRECT_URI = "http://localhost:8282/ufo/callback";
