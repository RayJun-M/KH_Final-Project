<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" %>
<%@ page import="java.util.ArrayList, com.urfavoriteott.urfavoriteott.movie.model.vo.Movie
			   , com.urfavoriteott.urfavoriteott.movie.controller.MovieController" %>
<%
        ...
        <div id="content_container">
            ...
            <div id="top_rate_container">
            	<% for(Movie m : movieHeader) { %>
            		<div><img src=<%= m.getBackdrop_path() %>></div>
                <% } %>
            </div>
            ...
            <div class="new_game_container">
            	...
            	<% for(Movie m : moviePopular) { %>
            		...
            		<div><a href=""><img class="thumbnail" src=<%= m.getPoster_path() %>></a>
            ...
            <div class="genre_search_container">
            	<% for(Movie m : movieLatest) { %>
            		<div><a href=""><img class="thumbnail" src=<%= m.getPoster_path() %>></a></div>
            	<% } %>
            </div>
            ...
            <div class="genre_search_container">
                <% for(Movie m : movieVideo) { %>
            		<div>
            			<iframe width="100%" height="350px" src="https://www.youtube.com/embed/<%= m.getVideo_key() %>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            		</div>
                <% } %>
            </div>
