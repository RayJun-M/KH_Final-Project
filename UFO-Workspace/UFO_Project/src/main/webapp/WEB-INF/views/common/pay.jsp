	...
	<div class="wrap">
		...
		<div class="content_container">
			...
			<div id="footer_navi">
           	...
           	<h4 class="policy"><b>유료상품 이용약관</b> <small>시행일자 : 2020-01-01</small></h4>

          	<div id="policy_wrap">

	          	<div id="policy_content">
	          		<p>제 1 조 [목적] <br>
					이 약관은 Ur Favorite OTT Corporation.(이하 회사)가 제공하는 유무선 인터넷 유료서비스 이용과 관련하여 회사와 이용자와의 권리, 의무 및 책임사항 등을 규정함을 목적으로 합니다. <br>
	          		</p>
	          		<p>제 2 조 [정의] <br>
