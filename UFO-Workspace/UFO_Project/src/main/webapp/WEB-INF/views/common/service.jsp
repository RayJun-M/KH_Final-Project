...
<body>
	...
	<div class="wrap">
		...
		<div class="content_container">
			...
			<div id="footer_navi">
		        <div id="selected_tab"><a href="service.main">서비스 이용약관</a></div>
		        <div><a href="pay.main">유료상품 이용약관</a></div>
		        <div><a href="personal.main">개인정보 처리방침</a></div>
			</div>

            <h4 class="policy"><b>서비스 이용약관</b> <small>시행일자 : 2020-01-01</small></h4>
            ...
            <div id="policy_wrap">
           		...
           		<div id="bizinfo">
           			<b>사업자 정보</b>
           			<p>
           			상호 : Ur Favorite OTT Corporation. <br>
           			대표이사 : 한다은 | 김수빈 | 박성현 | 신동민 | 장희연 | 황혜진 <br>
           			주소 : 서울특별시 영등포구 <br>
           			전화번호 : 고객센터 1599-3709 (평일 09:00~18:00, 점심시간 12:00~13:00, 주말 및 공휴일 휴무) <br>
           			전자우편주소 :  urfavoriteott@gmail.com
           			</p>
           		</div>
           		...
           		<div id="policy_content">
					<p>제 1 장 총칙</p>
						<p>제 1 조 (목적) <br>
						본 약관은 Ur Favorite OTT Corporation.(이하 회사라 합니다)가 제공하는 유무선 인터넷 관련 서비스를 이용함에 있어 회사와 이용자의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.
						</p>
						<p>제 2 조 (정의) <br>
						1. Ur Favorite OTT란 회사가 재화 또는 용역을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신 설비를 이용하여 재화 또는 용역을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 서비스를 제공하는 사업자의 의미로도 사용합니다. <br>
						2. 회사라 함은 콘텐츠 산업과 관련된 경제활동을 영위하는 자로서 콘텐츠 및 제반서비스를 제공하는 자를 말합니다. <br>
						3. 서비스라 함은 구현되는 단말기(PC, TV, 휴대형단말기 등의 각종 유무선 장치를 포함)와 상관없이 회원이 이용할 수 있는 Ur Favorite OTT 및 Ur Favorite OTT 관련 제반 서비스를 의미합니다. <br>
						...
						11. 회원탈퇴란 회원이 Ur Favorite OTT서비스의 이용계약을 해지하는 것을 의미합니다. <br>
						12. 제휴사란 회사와 공동 협력을 통해 회원에게 다양한 서비스와 혜택을 제공하는 제3의 서비스 및 마케팅 협력사를 말합니다. <br>
						</p>
						<p>제 3 조 [신원정보 등의 제공] <br>
					...
					<p>제 2 장 서비스 이용계약</p>
						...
						<p>제 7 조 [미성년자의 회원가입에 관한 특칙] <br>
						1. 만 14세 미만의 이용자는 개인정보의 수집 및 이용목적에 대하여 충분히 숙지하고 부모 등 법정대리인의 동의를 얻은 후에 회원가입을 신청하고 본인의 개인정보를 제공하여야 합니다. <br>
						2. 회사는 부모 등 법정대리인의 동의에 대한 확인절차를 거치지 않은 14세 미만 이용자에 대하여는 가입을 취소 또는 불허합니다.만 14세 미만이용자의 부모 등 법정대리인은 아동에 대한 개인정보의 열람, 정정, 갱신을 요청하거나 회원가입에 대한 동의를 철회할 수 있으며, 이러한 경우에 회사는 지체 없이 필요한 조치를 취해야 합니다. <br>
						3. 단, 만 14세 미만의 이용자에 대하여 2020. 8. 14부터 잠정적으로 정책 변경 및 기능 개선 시점까지 신규 회원 가입을 중단합니다. <br>
						</p>
						<p>제 8 조 [회원정보의 변경] <br>
						1. 회원은 개인정보 관리 화면을 통하여 언제든지 본인의 개인정보를 열람하고 수정할 수 있습니다. 다만 서비스의 관리 및 유지를 위하여 필요한 실명, 생년월일,아이디(ID) 등 일부 정보는 임의로 수정할 수 없습니다. <br>
						...
						<p>제 9 조 [회원의 아이디(ID) 및 비밀번호의 관리에 대한 의무] <br>
						...
						3. 회사는 이용자가 이용신청 등에서 제공한 정보와 제1항에 의하여 수집한 정보를 당해 이용자의 동의 없이 목적 외로 이용하거나 제3자에게 제공할 수 없으며, 이를 위반한 경우에 모든 책임은 회사가 집니다. 다만, 다음의 경우에는 예외로 합니다. <br>
						...
						4. 회사가 제2항과 제3항에 의해 이용자의 동의를 받아야 하는 경우에는개인정보의 수집목적 및 이용목적, 제3자에 대한 정보제공관련사항(제공받는 자, 제공목적 및 제공할 정보의 내용)등에 관하여 정보통신망이용촉진 및 정보보호 등에 관한 법률 제22조 제2항이 규정한 사항을 명시하고 고지하여야 합니다. <br>
						5. 이용자는 언제든지 제3항의 동의를 임의로 철회할 수 있습니다. <br>
						6. 이용자는 언제든지 회사가 가지고 있는 자신의 개인정보에 대해 열람 및 오류의 정정을 요구할 수 있으며, 회사는 이에 대해 지체 없이 필요한 조치를 취할 의무를 집니다. 이용자가 오류의 정정을 요구한 경우에는 회사는 그 오류를 정정할 때까지 당해 개인정보를 이용하지 않습니다. <br>
						...
						9. 회사는 정보통신망이용촉진 및 정보보호에 관한 법률 등 관계 법령이 정하는 바에 따라 이용자의 개인정보를 보호하기 위해 노력합니다. 개인정보의 보호 및 사용에 대해서는 관련법령 및 회사의 개인정보보호정책이 적용됩니다. <br>
						</p>
					<p>제 3 장 계약 당사자의 의무</p>
						<p>제 11조 (회사의 의무) <br>
						1. 회사는 특별한 사정이 없는 한 회원이 서비스 이용을 신청한 날에 서비스를 이용할 수 있도록 합니다. <br>
						2. 회사는 본 약관에서 정한 바에 따라 계속적이고 안정적인 서비스의 제공을 위하여 지속적으로 노력하며, 설비에 장애가 생기거나 멸실된 때에는 지체 없이 이를 수리 복구하여야 합니다. 다만, 천재지변, 비상사태 또는 그 밖에 부득이한 경우나 회사의 사정상 서비스 제공이 곤란한 경우에는 그 서비스를 일시 중단하거나 중지할 수 있습니다. <br>
						3. 회사는 회원으로부터 소정의 절차에 의해 제기되는 의견이나 불만이 정당하다고 인정할 경우에는 적절한 절차를 거쳐 처리하여야 합니다. 처리시 일정 기간이 소요될 경우 회원에게 그 사유와 처리 일정을 알려주어야 합니다. <br>
						...
						3. 회원은 회사의 사전승낙 없이는 서비스를 이용하여 영업 기타 영리적 목적의 활동을 할 수 없으며, 그 영업활동의 결과와 회원이 약관에 위반한 영업활동을 하여 발생한 결과에 대하여 회사는 책임을 지지 않습니다. 회원은 이와 같은 영업활동으로 회사가 손해를 입은 경우 회사에 대하여 손해배상 의무를 집니다. <br>
					...
					<p>제 4 장 서비스 이용</p>
						<p>제 13 조 (서비스의 제공 등) <br>
						1. 회사는 회원에게 아래와 같은 서비스를 제공합니다. <br>
						① TV 및 라디오 방송 콘텐츠 기반 서비스(VOD, AOD, “ON-AIR”, Text등) <br>
						...
						4. 회사는 컴퓨터 등 정보통신설비의 보수점검, 교체 및 고장, 통신두절 또는 운영상 상당한 이유가 있는 경우 서비스의 제공을 일시적으로 중단할 수 있습니다. 이 경우 회사는 본 약관상 정한 방법에 따라 회원에게 통지하되, 회사가 사전에 통지할 수 없는 부득이한 사유가 있는 경우에는 사후에 통지할 수 있습니다. <br>
						5. 회사는 서비스의 제공에 필요한 경우 정기점검을 실시할 수 있으며, 정기점검시간은 서비스제공화면에 공지한 바에 따릅니다. <br>
						</p>
						<p>제 14 조 (서비스의 변경 등) <br>
						...
						2. 회사는 회원에게 편리하고 다양한 서비스를 제공하기 위하여 관련 법령이 정한 절차와 제한 범위 내에서 회원으로부터 수집한 개인정보를 이용하여 회사가 제공하는 각종 서비스에 대한 정보, 광고, 타사의 상품이나 서비스, 이벤트 등에 대한 광고를 회사가 직접 또는 제휴사와 함께 전자우편, DM(우편) 등의 방법으로 광고하거나 제공할 수 있습니다. 이 경우 회원은 관련 법에 따른 거래 관련 정보 및 고객 문의 등에 대한 답변 등을 제외하고는 언제든지 전자우편 등에 대해서 서비스 및 광고를 거절할 수 있습니다. <br>
						3. 회사는 서비스에 관한 정보 등의 기타 마케팅 및 홍보활동을 함에 있어 TM(텔레마케팅), SMS(핸드폰 문자메세지) 및 모사 전송기기에 의하여 그 정보를 회원에게 전송하고자 하는 경우, 회원의 사전 동의를 받아 전송합니다. 다만 회원의 거래 관련 정보 및 고객문의 등에 대한 답변은 그렇지 아니합니다. <br>
						...
						<p>제 17 조 (게시물 삭제) <br>
						1. 회사는 게시판에 정보통신망이용촉진 및 정보보호 등에 관한 법률을 위반한청소년유해매체물이 게시되어 있는 경우에는 이를 지체 없이 삭제 합니다. 다만, 19세 이상의 이용자만 이용할 수 있는 게시판은 예외로 합니다. <br>
						...
						<p>제 18 조 (저작권 등의 귀속) <br>
						1. 회사가 작성한 저작물에 대한 저작권 기타 지적재산권은 회사에 귀속합니다. <br>
						2. 회사가 제공하는 서비스 중 제휴계약에 의해 제공되는 저작물에 대한 저작권 기타 지적재산권은 해당 제공업체에 귀속합니다. <br>
						3. 이용자는 회사가 제공하는 서비스를 이용함으로써 얻은 정보 중 회사 또는 제공업체에 지적재산권이 귀속된 정보를 회사 또는 제공업체의 사전승낙 없이 복제, 전송, 출판, 배포, 방송 기타 방법에 의하여 영리 혹은 비영리 목적으로 이용하거나 제3자에게 이용하게 하여서는 안 됩니다. <br>
						4.회사는 약정에 따라 이용자의 저작물을 사용하는 경우 당해 이용자의 허락을 받습니다. <br>
						</p>
						<p>제 19 조 [정보의 제공 및 광고의 게재] <br>
					...
					<p>제 5 장 계약 해지 및 이용 제한</p>
						<p>제 22 조 [회원탈퇴 및 자격 상실 등] <br>
						1. 회원은 회사에 언제든지 탈퇴를 요청할 수 있으며 회사는 즉시 회원탈퇴를 처리합니다. <br>
						①“MY>정보수정>회원탈퇴”에서 언제든지 탈퇴를 요청할 수 있으며, 고객센터 e-mail, 전화 등으로 연락하시면 신속하게 개인정보의 삭제 등 필요한 조치를 합니다. <br>
						②회원탈퇴 시 개인정보는 “개인정보 취급방침”에 따라 관리/삭제 조치되며, 보유 이용권과 개별구매 콘텐츠(영구 소장 포함), 쿠폰 및 무상으로 지급된 코인 모두 소멸되며 해당 서비스를 이용할 수 없습니다. <br>
					...
					<p>제 6 장 손해배상 및 기타 사항</p>
						<p>제 23 조 (손해배상) <br>
						1. 회사가 제공하는 무료서비스를 이용하는 과정에서 발생한 회원의 손실 또는 손해에 관하여, 회사는 고의 또는 과실로 인하여 발생한 상당인과관계 있는 손해에 대하여 책임을 부담합니다. 다만 회원이 무료서비스를 이용하지 못한 자체에 대하여 회사는 배상책임이 없습니다. <br>
