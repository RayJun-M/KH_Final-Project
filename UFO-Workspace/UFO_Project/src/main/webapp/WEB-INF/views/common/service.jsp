...
<body>
    ...
    <div class="wrap">
        ...
        <div id="content_container">
            ...
            <h4><b>서비스 이용약관</b> <small>시행일자 : 2021-10-21</small></h4>
            ...
            <div id="policy_wrap">
           		...
           		<p>제 1 장 총칙</p>
           			<p>제 1 조 (목적) <br> 
           			본 약관은 콘텐츠웨이브 주식회사(이하 회사라 합니다)가 제공하는 유무선 인터넷 관련 서비스를 이용함에 있어 회사와 이용자의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.
           			</p>
           			<p>제 2 조 (정의) <br>
				...
				<p>부칙 <br>
				(시행일) 이 약관은 2021년 10월 21일부터 시행합니다.
				</p>
			</div>
        </div>
