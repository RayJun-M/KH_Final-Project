package com.urfavoriteott.urfavoriteott.movie.controller;
...
import com.urfavoriteott.urfavoriteott.movie.model.vo.Movie;
    ...
    public ArrayList<Movie> getMovieTopRated() {
        ...
        try {
            ...
            for(int i = 0; i < 5; i++) {
            	...
            	m.setBackdrop_path("https://image.tmdb.org/t/p/original" + content.get("backdrop_path").toString());
    ...
    public ArrayList<Movie> getMoviePopular() {
        ...
        try {
            ...
            for(int i = 0; i < list.size(); i++) {
            	...
            	m.setPoster_path("https://image.tmdb.org/t/p/w500" + content.get("poster_path").toString());
    ...
    public ArrayList<Movie> getMovieLatest() {
        ...
        try {
            ...
            for(int i = 0; i < list.size(); i++) {
            	...
            	m.setPoster_path("https://image.tmdb.org/t/p/w500" + content.get("poster_path").toString());
            	m.setId(content.get("id").toString());
    ...
    public ArrayList<Movie> getMovieVideo(String id) {
        ...
        try {
            ...
            for(int i = 0; i < list.size(); i++) {
            	...
            	m.setVideo_key(content.get("key").toString());
